...
const dataImg =[img01,img02,img04,img02,img05]
                  ...
                  return (
                    <>
                      <Card style={{ width: '20rem', height: "18rem" }} className="mt-4 mb-4">
                        <Card.Img variant="top" style={{ width: '20rem', marginLeft: -13, backgroundSize:"cover", backgroundPosition:"center" }} src={img02} />
